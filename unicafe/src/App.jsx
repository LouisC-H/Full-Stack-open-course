...
<div>No feedback given</div>
  return(
    ...
    // <div>
    //   <Header headerText={"give feedback"}></Header>
    //   <StatisticLine text={voteOptions[0].name} value={voteOptions[0].numVotes} />
    //   <StatisticLine text={voteOptions[1].name} value={voteOptions[1].numVotes} />
    //   <StatisticLine text={voteOptions[2].name} value={voteOptions[2].numVotes} />
    //   <StatisticLine text={"all"} value={numTotalVotes(voteOptions)} />
    //   <StatisticLine text={"average"} value={calcAverage(voteOptions)} />
    //   <StatisticLine text={"positive"} value={percPostitive(voteOptions)} />
    // </div>
  )
}
