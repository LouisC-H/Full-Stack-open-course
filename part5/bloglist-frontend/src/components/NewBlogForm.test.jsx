...
describe('<NewBlogForm />', () => {
  ...
  beforeEach(() => {
    ...
    container = render(
      <NewBlogForm user={user} createBlog={mockCreateBlogHandler} sendNotification={mockSendNotificationHandler} />
    ).container
  })
  ...
  test('Create a new blog and check that the event handler receives the right details', async () => {
    ...
    expect(mockCreateBlogHandler.mock.calls[0][0]).toStrictEqual(newBlogExpected)
  })
})